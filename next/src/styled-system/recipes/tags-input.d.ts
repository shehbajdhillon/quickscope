...
export interface TagsInputRecipe {
  ...
  (props?: TagsInputVariantProps): Pretty<Record<"root" | "label" | "control" | "input" | "clearTrigger" | "item" | "itemInput" | "itemText" | "itemDeleteTrigger" | "root" | "label" | "control" | "input" | "clearTrigger" | "item" | "itemInput" | "itemText" | "itemDeleteTrigger", string>>
